...
.parallax {
    ...
    background-image: url("picture/toll3.png");
    height: 100%;
...
.parallax1 {
    ...
    background-image: url("picture/toll2.png"); 
    height: 100%;
...
<body data-spy="scroll" data-target=".navbar" data-offset="50" onload="myFunction()"> 
    ...
    <div class="parallax foo">
       ...
       <div class="hero-text" style="font-size:50px; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white;">
            ...
            <h1 class="animated rubberBand" ><b>TOLL TECH</b></h1>
            <p>A management system where you can easily manage vehicles and Tollgate</p>
       ...
       <br><br>
        <div id="bus_route" class="container">
          <div class="page-header">
            <h1 style="text-align: center">Find me</h1>      
          </div> 
          <div class="row">
        ...
        <br>
        <div class="page-header">
            <h1 style="text-align: center">Tollgate</h1>      
        </div>
        ...
        <div id="bus" class="container">
          ...
          <div class="row">
              <div class="col-md-6">
                ...
                <img src="picture/busimage.jpg" class="img-responsive" >  
              </div>
        ...
        <footer style="background-color: #2f2f2f;
          ...
          padding-bottom: 70px;" class="container-fluid text-center">
                <p>@Sarumathi 2022115059</p> 
                <p>@Karthika 2022115043</p> 
        </footer>
