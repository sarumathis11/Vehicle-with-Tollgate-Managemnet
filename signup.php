...
if (isset($_POST['submit'])) {
    ...
    $signup_query = "INSERT INTO user1(first_name, last_name, email, username, password, wallet_balance) 
                     VALUES ('$firstname','$lastname','$email','$username','$password','$wallet_balance')";
