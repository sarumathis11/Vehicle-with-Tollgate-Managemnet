...
CREATE TABLE `user` (
  ...
  `password` varchar(255) NOT NULL,
  `admin` int(11) NOT NULL,
  `wallet_balance` DECIMAL(10,2) DEFAULT 0, -- Add this line
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- ALTER TABLE `user` ADD COLUMN `wallet_balance` DECIMAL(10,2) DEFAULT 0;

ALTER TABLE `booking` ADD COLUMN `paid` DECIMAL(10,2) DEFAULT 0;
-- CREATE TABLE `user` (
--   `user_id` int(11) NOT NULL,
--   `first_name` varchar(255) NOT NULL,
--   `last_name` varchar(255) NOT NULL,
...
--   `wallet_balance` DECIMAL(10,2) DEFAULT 0, -- Add this line
-- ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
-- Create a new table to store user wallet balances
CREATE TABLE `wallet` (
  `user_id` int(11) NOT NULL,
...
INSERT INTO `wallet` (`user_id`, `wallet_balance`) VALUES
(10, 0), -- Assuming user_id 10 is Fahad
(13, 0),
(14, 0);

-- Modify the user table structure (remove wallet_balance from the user table)
...
ALTER TABLE `user` ADD COLUMN `totalcost` DECIMAL(10, 2) DEFAULT 0;
