<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $login_query = "SELECT * FROM user1 WHERE username='$username' and password='$password'";
        
        $login_res = pg_query($connection, $login_query);
        if(pg_num_rows($login_res) > 0){ 
            $_SESSION['username'] = $username;
            header('Location:tollgate.php');
        } 
        else{
