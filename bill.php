...
<head>
    ...
    <script>
        ...
        function calculateCost() {
            ...
            var oilCost = km * 15;
            var extraCost = oilCost * 0.5;
            var totalCost = oilCost + extraCost;

            document.getElementById('oil').value = oilCost.toFixed(2);
            document.getElementById('extra').value = extraCost.toFixed(2);
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            kmInput.addEventListener('input', calculateCost);
        });
    </script>
