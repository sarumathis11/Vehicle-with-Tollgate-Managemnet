    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <!-- <form class="animated bounce"  method="post">    -->
                    ...
                    <br>
                      ...
                      <div class="input-group">
                        ...
                        <input id="department" type="text" class="form-control" name="department"
                            value="<?php echo $bookingDetails['state']; ?>" required>
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="two wheeler">Two wheeler</label>
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>Time of crossing</b></span>
                      <input id="req_date" type="text" class="form-control" name="req_date" placeholder="Time of entering" required>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><b>Time of Return</b></span>
                      <input id="return_date" type="text" class="form-control" name="return_date" placeholder="Time of return" required>
...
<!-- Additional Fields -->
<div class="input-group">
            <span class="input-group-addon"><b>Booking ID</b></span>
            <input type="text" class="form-control" name="booking_id" readonly value="<?php echo uniqid(); ?>">
        </div>
        <br>

        <!-- <div class="input-group">
            <span class="input-group-addon"><b>Confirmation</b></span>
            <input type="checkbox" class="form-control" name="confirmation" value="1">
        </div> -->
        <!-- <br> -->

        <div class="input-group">
            <span class="input-group-addon"><b>Vehicle Registration</b></span>
            <input type="text" class="form-control" name="veh_reg" placeholder="Vehicle Registration" required>
        </div>
        <br>
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="total_km" placeholder="Total KM" required>
        </div>
        <br>

        <div class="input-group">
            <span class="input-group-addon"><b>Oil Cost</b></span>
            <input type="text" class="form-control" name="oil_cost" placeholder="Oil Cost" required>
        </div>
        <br>

        <div class="input-group">
            <span class="input-group-addon"><b>Extra Cost</b></span>
            <input type="text" class="form-control" name="extra_cost" placeholder="Extra Cost" required>
        </div>
        <br>
