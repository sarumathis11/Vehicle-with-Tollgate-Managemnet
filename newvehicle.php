<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $res = false;
        $insert_query = "INSERT INTO vehicle(veh_reg, veh_type, chesisno, brand, veh_color, veh_regdate, veh_description, veh_photo,veh_available) VALUES ('$regno','$type','$chesisno','$brand','$color','$regdate','$description','$photo',0)";
        $update_query = "UPDATE vehicle SET veh_available = 1 WHERE veh_available IS NULL";
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group">
                  ...
                  <input id="vehreg" type="text" class="form-control" name="vehregno" placeholder="TN-- ----">
                </div>
                <br> 
                ...
                <br> 
                 ...
                 <div class="input-group">
                  ...
                  <input id="vehchesis" type="text" class="form-control" name="vehchesis" placeholder="-----------------">
                </div>
                <br> 
