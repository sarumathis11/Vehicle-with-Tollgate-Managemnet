<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $res = false;
        $insert_query = "INSERT INTO driver (drname, drjoin, drmobile, drnid, drlicense, drlicensevalid, draddress, drphoto, dr_available) VALUES ('$drname', '$drjoin', '$drmobile', '$drnid', '$drlicense', '$drlicensevalid', '$draddress', '$drphoto', 0)";
        $update_query = "UPDATE driver SET dr_available = 1 WHERE dr_available IS NULL";
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
                ...
                <br>
                 ...
                 <div class="input-group">
                  ...
                  <input id="drnid" type="text" class="form-control" name="drnid" placeholder="Nid No 12 digits">
                </div>
                <br> 
                
                <div class="input-group">
                  <span class="input-group-addon"><b>License No</b></span>
                  <input id="drlicense" type="text" class="form-control" name="drlicense" placeholder="AA-00-0000-0000000">
                </div>
                <br>
